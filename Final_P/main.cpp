...
void timer(int t) {
    printf("nowtimer(%d)\n", t);
    glutTimerFunc(11, timer, t+1); ///馬上設定下一個鬧鐘
...
void display()
{
    ...
    if(head==NULL){
        ...
        ground=glmReadOBJ("model/ground.obj");
        cloud=glmReadOBJ("model/cloud.obj");
        star=glmReadOBJ("model/star.obj");
        ...
        glColor3f(159/255.0,252/255.0,253/255.0);
        glmDraw(ground,GLM_MATERIAL);
        glColor3f(192/255.0,192/255.0,192/255.0);
        glmDraw(cloud,GLM_MATERIAL);
        glColor3f(255/255.0,253/255.0,85/255.0);
        glmDraw(star,GLM_MATERIAL);
        glColor3f(0,0,0);
        glmDraw(plane,GLM_MATERIAL);
    ...
    glPopMatrix();
        ...
        glColor3f(136/255.0,0/255.0,21/255.0);
        glmDraw(hair,GLM_MATERIAL);
        glColor3f(0,0,0);
